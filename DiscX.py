...
def main():
    ...
    [7]: Mass Channel Deleter / [8]: Embed Message
    '''
    ...
    option = input('>>> ')
    features = [main_joinServer, main_leaveServer, main_statusTextChanger, main_statusTypeChanger, main_messageSpammer, main_massChannelCreator, main_massChannelDeleter, main_embedMessage]
    cls()
